...
- *Activer ou Désactiver la détection de mouvement* : permet d’activer ou de désactiver la détection de mouvement (par Surveillance Station ou par Caméra) SEULEMENT quand la caméra est activée
