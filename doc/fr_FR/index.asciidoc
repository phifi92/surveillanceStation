...
- Surveillance Station :
[horizontal]
- *Camera, SnapShot, PTZ, Enregistrment* : Surveillance Station 6.0-2337 et ultérieur
- *Live* : Surveillance Station 6.3 et ultérieur
- *Détection de mouvement* : Surveillance Station 7.0 et ultérieur
- *Home Mode* : Surveillance Station 8.1.0DSM 5 et ultérieur et ultérieur
...
Il est possible de demander à Surveillance Station d'alerte Jeedom lors d'un changement de statut de Home Mode à l'aide du règle dans Surveillance Station.
