...
==== Installation
Nachdem Sie das Plugin über den Markt installiert haben (ist es ratsam, die stabile Version zu nehmen). Sie kommen automatisch auf diese Seite :
...
- auf diese Seite gehen https://www.dropbox.com/developers-v1/
